...
load_dotenv(f"{local_base_dir}/.env", override=True)
print(f"local_base_dir: {local_base_dir}")
print(os.listdir(local_base_dir))

# -----------------------------------------------------------------------------
# Environment Variables
# -----------------------------------------------------------------------------
org = os.environ.get("ORGANIZATIONAL_NAME")
project = os.environ.get("PROJECT_NAME")
repo = os.environ.get("REPO_NAME")
branch_name = os.environ.get("FEATURE_BRANCH")
directory = os.environ.get("FABRIC_WORKSPACE_DIRECTORY")
...
def get_latest_commit_id() -> str:
    ...
    url = f"{base_url}/commits?searchCriteria.itemVersion.version={branch_name}&$top=1&api-version=7.1-preview.1"
